...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "." + "2b7963faabb73306d118" + ".js"
/******/ 	}
/******/
...
/******/ 				var href = "css/" + chunkId + "." + "2b7963faabb73306d118" + ".css";
...
/******/ 	__webpack_require__.p = "/xl-vision/";
/******/
...
*/
var aa=__webpack_require__(1),n=__webpack_require__(11),ba=__webpack_require__(18);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var routes_routes = [{
  ...
  children: [{
    ...
    component: function component() {
      return Promise.all(/* import() */[__webpack_require__.e(1), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, 64));
    }
  }]
}];
/* harmony default export */ var src_routes = (routes_routes);
// EXTERNAL MODULE: ./src/components/aside/index.scss
var aside = __webpack_require__(26);

// CONCATENATED MODULE: ./src/components/aside/index.tsx




/* harmony default export */ var components_aside = (function () {
  return react["createElement"]("div", {
    className: 'aside'
  }, aside_buildMenus(src_routes));
});

var aside_buildMenus = function buildMenus(routes) {
  var nodes = [];
  routes.forEach(function (it, index) {
    if (it.component) {
      nodes.push(react["createElement"]("li", {
        key: index,
        className: 'menu-item'
      }, react["createElement"](es_Link, {
        to: it.path
      }, it.name)));
    } else if (it.children) {
      nodes.push(react["createElement"]("li", {
        ...
        className: 'menu-name'
      }, it.name), buildMenus(it.children)));
    }
  });
...
// EXTERNAL MODULE: ./src/components/content/index.scss
...
var content_addRoute = function addRoute(routes) {
  var level = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '1';
  routes.forEach(function (it, index) {
    var key = "".concat(level, "_").concat(index);

    if (it.component) {
      var componentRoute = it;
      var loadable = lib({
      ...
      routeComponents.push(react["createElement"](react_router_dom_es_Route, {
        exact: true,
        key: key,
      ...
      var redirectRoute = it;
      routeComponents.push(react["createElement"](react_router_dom_es_Route, {
        exact: true,
        key: key,
        path: redirectRoute.path,
        component: function component() {
          return react["createElement"](react_router_dom_es_Redirect, {
            to: redirectRoute.redirect
          });
        }
      }));
    } else {
      var childrenRoute = it;
      addRoute(childrenRoute.children, key);
    }
  });
};

content_addRoute(src_routes);
/* harmony default export */ var components_content = (function () {
  return react["createElement"]("div", {
    className: 'content'
  }, routeComponents);
});
// EXTERNAL MODULE: ./src/components/footer/index.scss
...
/* harmony default export */ var components_header = (function () {
  return react["createElement"]("header", {
    ...
    href: '/',
    className: 'logo'
  }, react["createElement"]("h1", null, "Xl Vision")));
});
...
function (_React$Component) {
  inherits_default()(Layout, _React$Component);

  function Layout() {
    classCallCheck_default()(this, Layout);

    return possibleConstructorReturn_default()(this, getPrototypeOf_default()(Layout).apply(this, arguments));
  }

  createClass_default()(Layout, [{
    key: "render",
    value: function render() {
      return react["createElement"](es_HashRouter, null, react["createElement"]("div", {
        className: 'layout'
      }, react["createElement"](components_header, null), react["createElement"]("div", {
        className: 'content-wrapper'
      }, react["createElement"](components_aside, null), react["createElement"](components_content, null)), react["createElement"](components_footer, null)));
    }
  }]);
...
var theme_default = __webpack_require__(31);
...
react_dom["render"](react["createElement"](layout_Layout, null), document.querySelector('#app'));
